...
const PillNav = ({
  ...
  return (
    <div className="pill-nav-container">
      <nav 
        className={`pill-nav ${className} ${isScrolled ? 'is-scrolled' : ''}`} 
        aria-label="Primary" 
        style={cssVars}
      >
          ...
          >
            <div className="pill-logo-icon">
              <div ref={logoImgRef} className="w-full h-full flex items-center justify-center">
                {typeof logo === 'string' ? <img src={logo} alt={logoAlt} className="w-full h-full object-contain" /> : logo}
              </div>
            </div>
            {brandName && <span className="pill-logo-text whitespace-nowrap hidden sm:inline-block">{brandName}</span>}
          </Link>
        ) : (
          <a
            className="pill-logo"
